<form action="<?=HOST?>lost-password" method="POST" id="login-form" class="login-form" novalidate>
	...
	<div class="text-center pt-30">
		<input type="hidden" name="lost-password" value="lost-password">
		<input type="submit" class="button button--enter pl-50 pr-50" value="Восстановить пароль">
	</div>
</form>