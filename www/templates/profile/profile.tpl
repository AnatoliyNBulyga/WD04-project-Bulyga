		...
		<div class="row">
			<div class="col-md-auto">
				<div class="avatar">
					...
					<?php if ( $_SESSION['logged_user']['avatar'] != "" ) { ?>
						<img src="<?=HOST?>usercontent/avatar/<?=$_SESSION['logged_user']['avatar']?>" alt="<?=$_SESSION['logged_user']['firstname']?>" />		
					<?php } ?>
			...
			<div class="col ml-35">
				...
				<div class="user-description mb-20">
					...
					<div class="user-description__desc"><?=$_SESSION['logged_user']['email']?></div>
				</div>
				<div class="user-description mb-20">
					<div class="user-description__title">Страна, Город</div>
					<div class="user-description__desc"><?=$_SESSION['logged_user']['country']?>, <?=$_SESSION['logged_user']['city']?></div>
				</div>
			</div>
		</div>
